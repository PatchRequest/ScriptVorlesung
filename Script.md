...
Im digitalen Zeitalter hat sich die Kriminalität grundlegend gewandelt. Cybercrime, also Kriminalität, die im digitalen Raum stattfindet oder digitale Technologien nutzt, stellt eine der größten Bedrohungen für Individuen, Unternehmen und Staaten dar. Dabei hat sich Cybercrime zunehmend professionalisiert und kommerzialisiert: Von einzelnen, opportunistisch agierenden Hackern hat sich die Szene zu einem ökonomisch organisierten Netzwerk entwickelt. Spezialisierte Akteure arbeiten gezielt zusammen und bieten ihre Dienstleistungen in Marktplätzen und Foren an, die sowohl Anfänger als auch Schwerkriminelle anziehen. Nulled und BreachForums dienen hier als Paradebeispiele: Während Nulled vor allem Anlaufstelle für sogenannte "Script Kiddies" ist, die mit grundlegenden Tools und Tutorials experimentieren, richtet sich BreachForums gezielt an erfahrene Cyberkriminelle, die große Mengen gestohlener Daten handeln oder schwerwiegende Angriffe planen.

## Marktplätze und Foren für Cybercrime

### **Nulled**
Nulled ist eine Online-Plattform, die sich durch ihr breites Angebot an gehackten Accounts, Software-Cracks und einfachen Tutorials auszeichnet. Sie zieht vor allem Einsteiger an, die wenig technisches Wissen besitzen und vorgefertigte Tools und Skripte nutzen. Besonders beliebt sind bereits konfigurierte Angriffs-Tools wie **Sentry MBA** oder **OpenBullet**, die von erfahrenen Nutzern in den Foren erstellt und geteilt werden. Einsteiger, oft als "Script Kiddies" bezeichnet, laden sich sogenannte **Configs** sowie zufällige **Combolisten** herunter und setzen diese ein, um durch **Credential Stuffing** Zugriff auf Konten zu erhalten. Diese Vorgehensweise macht es besonders einfach, kriminelle Aktivitäten zu starten, ohne tiefergehende technische Kenntnisse besitzen zu müssen.

### **BreachForums**
Im Gegensatz zu Nulled nimmt BreachForums eine deutlich zentralere Rolle im professionellen Cybercrime-Umfeld ein. Nach der Schließung von RaidForums etablierte sich BreachForums als ein Forum, das für den Handel von riesigen Datenmengen bekannt wurde. Cyberkriminelle aus der ganzen Welt boten dort E-Mail-Passwort-Kombinationen, Kreditkarteninformationen und sensible Unternehmensdaten an. Die Plattform dient als Marktplatz für gestohlene Informationen, aber auch als Drehscheibe für Exploits und hochspezialisierte Tools, die für gezielte Angriffe eingesetzt werden. Anders als auf Nulled agieren hier oft erfahrene und hochkriminelle Akteure, die mit organisierter Struktur und hoher Professionalität vorgehen.

### **Darknet-Märkte und organisierte Gruppen**
Neben den leicht zugänglichen Foren wie Nulled und BreachForums existieren im Darknet anonyme Marktplätze, die für den Handel mit illegalen Gütern genutzt werden. Dazu gehören Drogen, gefälschte Dokumente, gestohlene Identitäten und Exploit-Kits. Der Aufbau dieser Plattformen erinnert zunehmend an legitime Handelsportale, was ihre Professionalität und kommerzielle Ausrichtung unterstreicht. Gleichzeitig haben sich **organisierte Cybercrime-Gruppen**, wie die Conti-Ransomware-Gruppe, etabliert. Conti war bekannt dafür, durch gezielte Angriffe Unternehmen zu verschlüsseln und immense Erpressungssummen zu fordern. Ihre Aktivitäten verdeutlichen, dass Cybercrime nicht mehr nur aus isolierten Angriffen besteht, sondern von durchstrukturierten Organisationen ausgeführt wird, die nach betriebswirtschaftlichen Prinzipien arbeiten.

## Techniken und Methoden des Cybercrime

### **SIM-Swapping**
SIM-Swapping ist ein Beispiel für die zielgerichtete Vorgehensweise moderner Cyberkrimineller. Hierbei wird die Telefonnummer eines Opfers von einer bestehenden SIM-Karte auf eine neue Karte des Angreifers übertragen. Mit dieser Kontrolle gelingt es Angreifern, Zwei-Faktor-Authentifizierungssysteme zu überlisten und auf sensible Informationen wie Bankkonten oder Kryptowallets zuzugreifen. Mittlerweile hat sich auch um SIM-Swapping ein professionelles, mehrstufiges System entwickelt. Es existieren **kommerzielle Services**, die ganze Teams einsetzen: Ein Mitarbeiter kümmert sich beispielsweise darum, das Tablet eines Telekommunikationsmitarbeiters zu stehlen, während ein anderer innerhalb weniger Minuten, bevor das Gerät remote gesperrt wird, den eigentlichen Swap durchführt. Der Kunde selbst bekommt von diesem Prozess häufig nichts mit, da die Systeme im Hintergrund reibungslos und effizient funktionieren.

### **Credential Stuffing**
Credential Stuffing zeigt besonders deutlich, wie Cybercrime von der Massenautomatisierung profitiert. Bei dieser Methode werden gestohlene Zugangsdaten aus Datenlecks mithilfe automatisierter Tools systematisch bei verschiedenen Websites getestet. Da viele Benutzer ihre Passwörter wiederverwenden, ist diese Technik besonders effizient. Tools wie **Sentry MBA** und **OpenBullet** bieten dabei eine zentrale Rolle: Diese Programme können mit vorkonfigurierten **Configs** ausgestattet werden, die spezifische Websites angreifen. Diese **Configs** werden in Foren wie Nulled zum Verkauf oder kostenlosen Download angeboten, zusammen mit zufälligen **Combolisten**, die Millionen von Zugangsdaten enthalten. Diese Kombination aus automatisierten Tools und der Verfügbarkeit von Ressourcen macht Credential Stuffing zu einer bevorzugten Methode für "Script Kiddies", die ohne tiefgreifendes technisches Wissen Schaden anrichten können.

### **E-Whoring**
E-Whoring illustriert, wie kommerziell orientiert Cybercrime geworden ist. Dabei erstellen Betrüger gefälschte Profile, oft basierend auf gestohlenen Bildern und Videos, um potenzielle Opfer zu manipulieren und zur Zahlung von Geld zu bewegen. In den letzten Jahren hat sich E-Whoring zunehmend professionalisiert, indem **"Kits"** auf Marktplätzen wie Nulled angeboten werden. Diese Pakete enthalten fertige Skripte, Bilder und Videos sowie automatisierte Bots, die Gespräche mit den Opfern simulieren. Das gesamte System hat sich dadurch mehrstufig entwickelt: Während einige die Materialien erstellen, bieten andere fertige Komplettpakete an, die von technisch weniger versierten Nutzern direkt eingesetzt werden können.

### **Advanced Persistent Threats (APTs)**
Advanced Persistent Threats (APTs) markieren die Spitze der Professionalisierung im Cybercrime. Diese staatlich oder kommerziell unterstützten Gruppen verfolgen langfristige Angriffsziele, die oft politische oder wirtschaftliche Motive haben. Ein prominentes Beispiel ist die **Lazarus-Gruppe**, die mit Nordkorea in Verbindung gebracht wird und für ihre komplexen Angriffe bekannt ist. Lazarus agierte unter anderem beim Angriff auf die **Bangladesh Bank**, bei dem fast eine Milliarde US-Dollar gestohlen werden sollte. Der Angriff kombinierte ausgefeilte Malware mit gezieltem Social Engineering und verdeutlicht das hohe technische Niveau und die Organisationsstruktur solcher Gruppen.

## Fazit
Cybercrime hat sich zu einer hochgradig professionalisierten und kommerzialisierten Bedrohung entwickelt, die weit über das Bild einzelner Hacker hinausgeht. Plattformen wie Nulled dienen als Einstiegspunkt für Anfänger, die durch vorgefertigte Tools und Anleitungen in die Szene eingeführt werden, während Foren wie BreachForums als Handelsplatz für erfahrene Cyberkriminelle fungieren. Die zunehmende Arbeitsteilung, Automatisierung und Professionalisierung machen Cybercrime zu einer ernsthaften Herausforderung, der nur durch fundiertes Wissen und gezielte Gegenmaßnahmen begegnet werden kann. Gruppen wie Conti und Lazarus verdeutlichen dabei, dass moderne Cyberkriminalität sowohl finanziell als auch politisch motiviert ist und in ihrer Organisation klassischen Unternehmen immer ähnlicher wird.
